...
- `rforge screen configure|decide|adjudicate|queue|prioritize|model-prioritize|uncertainty|active-run|sensitivity|progress|recall|stopping|conflicts`, `rforge prisma counts`
