...
- `rforge screen assign --stage <stage> --reviewer <name> [--reviewer <name>] [--per-record N] --out <assignments.json>` assigns reviewers; `rforge screen panel --stage <stage> --out <panel.json>` exports conflict/adjudication panels; `rforge screen audit-bundle --stage <stage> --out <bundle.json> [--assignments <assignments.json> --active-run <run.json>]` exports screening audit bundles including uncertain queues
