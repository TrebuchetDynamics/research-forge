...
func TestDOAJConnectorSearchNormalizesOpenAccessCandidates(t *testing.T) {
	...
	if record.Source != "doaj" || record.Identifiers.DOI != "10.1000/doaj" || !record.OpenAccess || record.License != "CC-BY" || record.URLs[0] != "https://example.org/doaj.pdf" {
...
func TestCOREConnectorSearchNormalizesOpenAccessCandidates(t *testing.T) {
	...
	record := response.Records[0]
	if record.Source != "core" || record.Identifiers.DOI != "10.1000/core" || !record.OpenAccess || record.License != "CC-BY-4.0" || !strings.Contains(strings.Join(record.URLs, ";"), "core.pdf") {
		t.Fatalf("record = %#v", record)
	}
}

func TestCompareOpenAccessCandidatesCoversRequiredSources(t *testing.T) {
	paper := library.PaperRecord{Title: "Candidate fixture", Identifiers: library.Identifiers{DOI: "10.1000/candidate", ArXivID: "2401.12345", PMID: "123", PMCID: "PMC123"}, URLs: []string{"/tmp/local.pdf"}, License: "CC-BY", OpenAccess: true, SourceRefs: []library.SourceRef{{Source: "unpaywall", Metadata: map[string]string{"pdf_url": "https://example.org/unpaywall.pdf", "oa_status": "gold"}}, {Source: "doaj", Metadata: map[string]string{"full_text_url": "https://example.org/doaj.pdf", "license": "CC-BY"}}, {Source: "core", Metadata: map[string]string{"download_url": "https://example.org/core.pdf", "license": "CC-BY"}}, {Source: "europepmc", Metadata: map[string]string{"full_text_url": "https://example.org/pmc.pdf", "license": "CC-BY"}}}}
